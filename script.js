...
const translations = {
	pl: {
		...
		"nav.contact": "Kontakt",
		"hero.title":
			'Cześć<span class="punctuation">,</span> jestem <span class="name">Szymon</span> Kaput',
		"hero.subtitle":
			"Student informatyki specjalizujący się w cyberbezpieczeństwie",
		"hero.description":
			"Pasjonuje się nowymi technologiami, sieciami komputerowymi i bezpieczeństwem systemów. Aktualnie kończę studia inżynierskie i planuję kontynuować naukę na PJATK.",
		...
		"skills.linux":
			"Administracja systemami Linux, bash scripting, konfiguracja serwerów",
		"skills.windows": "Systemy Windows, Active Directory, PowerShell",
		"skills.networking.title": "Sieci komputerowe",
		"skills.networking.desc":
			"Konfiguracja sieci, protokoły, bezpieczeństwo sieciowe",
		...
		"skills.frontend.desc":
			"Projektowanie interfejsów użytkownika, doświadczenie użytkownika",
		...
		"skills.cicd.desc":
			"GitHub Actions, GitLab CI, Jenkins - automatyzacja wdrożeń",
		...
		"about.title": "O mnie",
		"about.intro":
			"Student informatyki na ostatnim roku studiów inżynierskich, specjalizujący się w cyberbezpieczeństwie.",
		"about.passion":
			"Zainteresowanie IT towarzyszyło mi od dziecka. Fascynuje mnie świat technologii, bezpieczeństwa systemów i sieci komputerowych.",
		"about.future":
			"Planuję kontynuować naukę na Polsko-Japońskiej Akademii Technik Komputerowych (PJATK), aby pogłębić swoją wiedzę w dziedzinie cyberbezpieczeństwa.",
		"about.personal":
			"Prywatnie jestem pasjonatem sportu, nowych technologii i narzędzi, które mogą pomóc w codziennej pracy i rozwoju osobistym.",
		"about.more": "Dowiedz się więcej",
		"blog.title": "Blog",
		"blog.post1.title": "Wprowadzenie do cyberbezpieczeństwa",
		"blog.post1.excerpt":
			"Podstawowe pojęcia i narzędzia w dziedzinie cyberbezpieczeństwa...",
		"blog.post2.title": "Python w automatyzacji zadań",
		"blog.post2.excerpt":
			"Jak wykorzystać Python do automatyzacji codziennych zadań...",
		"blog.post3.title": "Bezpieczeństwo sieci - podstawy",
		"blog.post3.excerpt":
			"Wprowadzenie do zabezpieczania sieci komputerowych...",
	...
	en: {
		...
		"nav.contact": "Contact",
		"hero.title":
			'Hi<span class="punctuation">,</span> I\'m <span class="name">Szymon</span> Kaput',
		"hero.subtitle": "Computer Science Student specializing in Cybersecurity",
		"hero.description":
			"I'm passionate about new technologies, computer networks and system security. Currently finishing my engineering studies and planning to continue education at PJATK.",
		...
		"skills.cicd.title": "CI/CD",
		"skills.cicd.desc":
			"GitHub Actions, GitLab CI, Jenkins - deployment automation",
		"skills.sql.title": "SQL",
		...
		"about.passion":
			"Interest in IT has accompanied me since childhood. I'm fascinated by the world of technology, system security and computer networks.",
		"about.future":
			"I plan to continue my education at the Polish-Japanese Academy of Information Technology (PJATK) to deepen my knowledge in cybersecurity.",
		"about.personal":
			"Privately, I'm passionate about sports, new technologies and tools that can help in everyday work and personal development.",
		"about.more": "Learn More",
		"blog.title": "Blog",
		"blog.post1.title": "Introduction to Cybersecurity",
		"blog.post1.excerpt":
			"Basic concepts and tools in the field of cybersecurity...",
	...
	de: {
		...
		"nav.contact": "Kontakt",
		"hero.title":
			'Hallo<span class="punctuation">,</span> ich bin <span class="name">Szymon</span> Kaput',
		"hero.subtitle":
			"Informatikstudent mit Spezialisierung auf Cybersicherheit",
		"hero.description":
			"Ich begeistere mich für neue Technologien, Computernetzwerke und Systemsicherheit. Derzeit beende ich mein Ingenieursstudium und plane, meine Ausbildung an der PJATK fortzusetzen.",
		...
		"skills.linux":
			"Linux-Systemadministration, Bash-Scripting, Serverkonfiguration",
		"skills.windows": "Windows-Systeme, Active Directory, PowerShell",
		"skills.networking.title": "Computernetzwerke",
		"skills.networking.desc":
			"Netzwerkkonfiguration, Protokolle, Netzwerksicherheit",
		...
		"skills.cicd.title": "CI/CD",
		"skills.cicd.desc":
			"GitHub Actions, GitLab CI, Jenkins - Deployment-Automatisierung",
		"skills.sql.title": "SQL",
		...
		"about.intro":
			"Informatikstudent im letzten Jahr mit Spezialisierung auf Cybersicherheit.",
		"about.passion":
			"Das Interesse an IT begleitet mich seit der Kindheit. Mich fasziniert die Welt der Technologie, Systemsicherheit und Computernetzwerke.",
		"about.future":
			"Ich plane, meine Ausbildung an der Polnisch-Japanischen Akademie für Informationstechnologie (PJATK) fortzusetzen, um mein Wissen im Bereich Cybersicherheit zu vertiefen.",
		"about.personal":
			"Privat bin ich leidenschaftlich interessiert an Sport, neuen Technologien und Tools, die bei der täglichen Arbeit und persönlichen Entwicklung helfen können.",
		"about.more": "Mehr erfahren",
		"blog.title": "Blog",
		"blog.post1.title": "Einführung in die Cybersicherheit",
		"blog.post1.excerpt":
			"Grundlegende Konzepte und Tools im Bereich Cybersicherheit...",
		"blog.post2.title": "Python in der Aufgabenautomatisierung",
		"blog.post2.excerpt":
			"Wie man Python zur Automatisierung alltäglicher Aufgaben nutzt...",
		"blog.post3.title": "Netzwerksicherheit - Grundlagen",
		"blog.post3.excerpt":
			"Einführung in die Sicherung von Computernetzwerken...",
	...
	es: {
		...
		"hero.title":
			'Hola<span class="punctuation">,</span> soy <span class="name">Szymon</span> Kaput',
		"hero.subtitle":
			"Estudiante de Informática especializado en Ciberseguridad",
		"hero.description":
			"Me apasionan las nuevas tecnologías, las redes informáticas y la seguridad de sistemas. Actualmente terminando mis estudios de ingeniería y planeando continuar la educación en PJATK.",
		...
		"skills.linux":
			"Administración de sistemas Linux, bash scripting, configuración de servidores",
		"skills.windows": "Sistemas Windows, Active Directory, PowerShell",
		"skills.networking.title": "Redes Informáticas",
		"skills.networking.desc":
			"Configuración de redes, protocolos, seguridad de red",
		"skills.php":
			"Desarrollo de aplicaciones web, Laravel, programación segura",
		...
		"skills.csharp":
			"Programación en C#, .NET Framework, aplicaciones de escritorio",
		"skills.frontend.title": "Frontend / UX",
		"skills.frontend.desc":
			"Diseño de interfaces de usuario, experiencia de usuario",
		"skills.webtech.title": "HTML5 / CSS3 / Tailwind",
		"skills.webtech.desc": "Tecnologías web modernas, diseño responsivo",
		"skills.cicd.title": "CI/CD",
		"skills.cicd.desc":
			"GitHub Actions, GitLab CI, Jenkins - automatización de despliegue",
		"skills.sql.title": "SQL",
		...
		"about.intro":
			"Estudiante de último año de Informática especializado en ciberseguridad.",
		"about.passion":
			"El interés por la informática me acompaña desde la infancia. Me fascina el mundo de la tecnología, la seguridad de sistemas y las redes informáticas.",
		"about.future":
			"Planeo continuar mi educación en la Academia Polaco-Japonesa de Tecnología de la Información (PJATK) para profundizar mis conocimientos en ciberseguridad.",
		"about.personal":
			"En lo personal, soy apasionado del deporte, las nuevas tecnologías y herramientas que pueden ayudar en el trabajo diario y el desarrollo personal.",
		"about.more": "Saber más",
		"blog.title": "Blog",
		"blog.post1.title": "Introducción a la Ciberseguridad",
		"blog.post1.excerpt":
			"Conceptos básicos y herramientas en el campo de la ciberseguridad...",
		"blog.post2.title": "Python en la Automatización de Tareas",
		"blog.post2.excerpt":
			"Cómo usar Python para automatizar tareas cotidianas...",
		"blog.post3.title": "Seguridad de Redes - Fundamentos",
		"blog.post3.excerpt":
			"Introducción a la seguridad de redes informáticas...",
...
async function loadGitHubProjects() {
	...
	try {
		const response = await fetch(
			"https://api.github.com/users/szymkap92/repos?sort=updated&per_page=6"
		);
		...
		const filteredRepos = repos.filter((repo) => {
			...
			return (
				!repo.fork && !excludedNames.includes(repo.name) && !isPortfolioVariant
			);
		});
		...
		const serviceMonitoringProject = {
			...
			description:
				"PowerShell script for monitoring Windows services and system resources",
			html_url: "https://github.com/szymkap92/Service-Monitoring",
			language: "PowerShell",
			homepage: null,
		};

		const serviceMonitoringExists = filteredRepos.some(
			(repo) => repo.name === "Service-Monitoring"
		);
		...
		const notebookExists = filteredRepos.some(
			(repo) => repo.name === "Notebook"
		);
		if (!notebookExists) {
			try {
				const notebookResponse = await fetch(
					"https://api.github.com/repos/szymkap92/Notebook"
				);
		...
		const miniHoneypotProject = {
			name: "Mini-honeypot",
			description:
				"Simple honeypot implementation for cybersecurity learning and threat detection",
			html_url: "https://github.com/szymkap92/Mini-honeypot",
			language: "Python",
			homepage: null,
		};

		const miniHoneypotExists = filteredRepos.some(
			(repo) => repo.name === "Mini-honeypot"
		);
		...
		if (filteredRepos.length === 0) {
			projectsContainer.innerHTML = `
                <div class="project-loading">
                    <p>${
											translations[currentLang]["projects.loading"] ||
											"No projects found"
										}</p>
                </div>
            `;
...
function handleContactFormSubmit(e) {
	...
	const successMessage =
		currentLang === "pl"
			? "Dziękuję za wiadomość! Klient email zostanie otwarty."
...
function initializeScrollAnimations() {
	...
	const elementsToAnimate = document.querySelectorAll(
		"section, .skill-item, .project-item, .blog-post"
	);
